  ...
  return (
    <>
      ...
      <div className="flex min-h-screen">
        ...
        <aside className="fixed left-0 top-16 z-40 h-[calc(100vh-4rem)] w-64 border-r border-slate-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/95">
          <div className="p-6">
        ...
        <main className="ml-64 flex-1">
          ...
          {/* CTA Section */}
          <section className="bg-blue-800 px-6 py-16 text-white md:px-12">
            <div className="mx-auto max-w-4xl text-center">
